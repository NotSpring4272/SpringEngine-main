	...
	var songLowercase = StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase();
		...
		switch (SONG.song.toLowerCase())
		{
		          ...
		          case 'cocoa' | 'eggnog':
		          {
		                  ...
		                  var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('backgrounds/christmas/bgWalls'));
		                  ...
		                  upperBoppers.frames = Paths.getSparrowAtlas('backgrounds/christmas/upperBop');
		                  ...
		                  var bgEscalator:FlxSprite = new FlxSprite(-1100, -600).loadGraphic(Paths.image('backgrounds/christmas/bgEscalator'));
		                  ...
		                  bottomBoppers.frames = Paths.getSparrowAtlas('backgrounds/christmas/bottomBop');
		                  ...
		                  var fgSnow:FlxSprite = new FlxSprite(-600, 700).loadGraphic(Paths.image('backgrounds/christmas/fgSnow'));
		                  fgSnow.active = false;
		                  fgSnow.antialiasing = true;
		                  add(fgSnow);

		                  santa = new FlxSprite(-840, 150);
		                  santa.frames = Paths.getSparrowAtlas('backgrounds/christmas/santa');
		          ...
		          {
		                  curStage = 'mallEvil';
		                  var bg:FlxSprite = new FlxSprite(-400, -500).loadGraphic(Paths.image('backgrounds/hristmas/evilBG'));
		                  bg.antialiasing = true;
		                  bg.scrollFactor.set(0.2, 0.2);
		                  bg.active = false;
		                  bg.setGraphicSize(Std.int(bg.width * 0.8));
		                  ...
		                  var evilTree:FlxSprite = new FlxSprite(300, -300).loadGraphic(Paths.image('backgrounds/christmas/evilTree'));
		                  evilTree.antialiasing = true;
		                  evilTree.scrollFactor.set(0.2, 0.2);
		                  add(evilTree);

		                  var evilSnow:FlxSprite = new FlxSprite(-200, 700).loadGraphic(Paths.image("backgrounds/christmas/evilSnow"));
		          ...
		          case 'senpai' | 'roses':
		          {
		                  ...
		                  var bgSky = new FlxSprite().loadGraphic(Paths.image('backgrounds/weeb/weebSky'));
		                  bgSky.scrollFactor.set(0.1, 0.1);
		                  add(bgSky);

		                  var repositionShit = -200;

		                  var bgSchool:FlxSprite = new FlxSprite(repositionShit, 0).loadGraphic(Paths.image('backgrounds/weeb/weebSchool'));
		                  bgSchool.scrollFactor.set(0.6, 0.90);
		                  add(bgSchool);

		                  var bgStreet:FlxSprite = new FlxSprite(repositionShit).loadGraphic(Paths.image('backgrounds/weeb/weebStreet'));
		                  bgStreet.scrollFactor.set(0.95, 0.95);
		                  add(bgStreet);

		                  var fgTrees:FlxSprite = new FlxSprite(repositionShit + 170, 130).loadGraphic(Paths.image('backgrounds/weeb/weebTreesBack'));
		                  fgTrees.scrollFactor.set(0.9, 0.9);
		                  add(fgTrees);

		                  var bgTrees:FlxSprite = new FlxSprite(repositionShit - 380, -800);
		                  var treetex = Paths.getPackerAtlas('backgrounds/weeb/weebTrees');
		                  ...
		                  treeLeaves.frames = Paths.getSparrowAtlas('backgrounds/weeb/petals');
		          ...
		          case 'thorns':
		          {
		                  ...
		                  bg.frames = Paths.getSparrowAtlas('backgrounds/weeb/animatedEvilSchool');
			...
			notes.forEachAlive(function(daNote:Note)
			{
				...
				if (!daNote.mustPress && daNote.wasGoodHit)
				{
                     ...
                     enemyStrums.forEach(function(spr:FlxSprite)
                    {
                         if (Math.abs(daNote.noteData) == spr.ID)
                        {
                            ...
                            if (spr.animation.curAnim.name == 'confirm' && !curStage.startsWith('school') && SONG.noteStyle != 'guitar')
                        {
                                 spr.centerOffsets();
                                spr.offset.x -= 14;
                                spr.offset.y -= 14;
                ...
                if (daNote.y < -daNote.height)
                {
                    switch (daNote.noteType)
                    {
                        ...
                        case 2: //deathmatch project custom note
                        {
                            daNote.kill();
                            notes.remove(daNote, true);
                            daNote.destroy();
